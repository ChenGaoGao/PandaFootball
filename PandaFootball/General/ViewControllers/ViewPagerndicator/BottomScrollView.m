...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView
{
    ...
    _pageChangedBlock(offsetx/self.frame.size.width);
...
{
    if (self.contentOffset.x<=0.0&&otherGestureRecognizer.class==[UIScreenEdgePanGestureRecognizer class]) {
        return YES;
    }
    return NO;
}
